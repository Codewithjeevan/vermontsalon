    ...
    <table class="w-100">
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <?php if ($customer_info->gst_number != 'NULL' && $s_status != 'Bangladesh') { ?>
                                        <p class="pb-3 color-71">
                                            <span
                                                class="f-w-600"><?php echo $inv_config->customer_tax_number_label; ?>:</span>
                                            <?php echo escape_output($customer_info->gst_number) ?>
                                        </p>
                                    <?php } ?>
                                    <p class="pb-3 color-71">
                                        <span class="f-w-600"><?= lang('stylish_name') ?>:</span>
                                        <?= implode(', ', array_column($sale_object->items, 'seller_name')) ?>
                                    </p>
                        ...
                        <div>
                            ...
                            if ($sale_object->total_payable) {
                                ...
                                <div class="d-flex justify-content-between pt-2 pb-3 mt-2 mb-2 border-bottom-dotted-gray">
                                    ...
                                    ?>
                                    <p><?php echo getAmtCustom($ln_text == "bangla" ? banglaNumber($totalpayable) : $totalpayable) ?>
                                    </p>
                                </div>
                                <?php
                            }
        ...
        <?php if ($inv_config->show_letter_head == 'Yes') { ?>
            <tfoot>
                <tr>
                    <td>
                        <div class="page-footer-space" style="height: <?php echo escape_output($letter_footer_gap) ?>;">
                        </div>
                    </td>
                </tr>
            </tfoot>
