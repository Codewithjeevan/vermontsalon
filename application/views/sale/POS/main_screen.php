...
<body>
    ...
    <input type="hidden" id="last_sale_no" value="<?php echo saleNoGenerator();?>">
    ...
    <aside id="pos__sidebar">
        ...
        <ul class="pos__menu__list">
            ...
            <li class="have_sub_menu2">
                <a href="<?php echo ($s_status == 'Bangladesh' && $pakl == 'silver') ? 'javascript:void(0)' : base_url().'Booking/booking'?>" class="child-menu">
                    <iconify-icon icon="solar:bookmark-broken" width="22"></iconify-icon>
            ...
            $company_id = $this->session->userdata('company_id');
            $user_id = $this->session->userdata('user_id');
            if((isServiceAccess2($user_id, $company_id,'sGmsJaFJE') == 'Saas Super Admin') && FCCPATH != 'Bangladesh'){ 
            ?>
            ...
            <?php } else if((isServiceAccess2($user_id, $company_id,'sGmsJaFJE') == 'Not SaaS') && FCCPATH != 'Bangladesh'){ ?>
            <li data-access="update-247" class=" have_sub_menu2 menu_assign_class" module-is-hide="Update Software-YES">
                <a class="child-menu " href="<?php echo base_url(); ?>Update/index">
                    <iconify-icon icon="solar:cloud-download-broken" width="22"></iconify-icon>
                    <span><?php echo lang('update_software'); ?></span>
