                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 mb-3">
                        <div class="form-group">
                            ...
                            <textarea  autocomplete="off" name="additional_information" rows="3" class="form-control ckeditor" placeholder="<?php echo lang('additional_information'); ?>"><?php echo escape_output(@$outlet_information->additional_information); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
