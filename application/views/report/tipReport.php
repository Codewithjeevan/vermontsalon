...
<div class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('tip_report'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('report'), 'secondSection'=> lang('tip_report')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        ...
        <div class="report_header">
            ...
            <h5 class="outlet_info">
                <strong><?php echo lang('tip_report'); ?></strong>
            </h5>
        ...
        <div class="table-box">
            ...
            <input type="hidden" class="datatable_name"  data-filter="yes" data-title="<?php echo lang('tip_report'); ?>" data-id_name="datatable">
                <table id="datatable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><?php echo lang('mode_of_payment'); ?></th>
                            <th class="text-center"><?php echo lang('total_payable'); ?></th>
                            <th class="text-center"><?php echo lang('paid_amount'); ?></th>
                            <th class="text-center"><?php echo lang('tip_amount'); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                        ...
                        if (isset($saleReport)):
                            foreach ($saleReport as $key => $value) {
                                ...
                                $given_amount += $value->given_amount;
                                $changeamount += $value->change_amount;
                                ...
                                <tr>
                                    ...
                                    <td><?php echo escape_output(@$value->seller_names ? $value->seller_names : 'N/A'); ?></td>
                                    <td class="text-center"><?php echo escape_output($paymentmethod); ?></td>
                                    <td class="text-center"><?php echo getAmtCustom($value->total_payable); ?></td>
                                    <td class="text-center"><?php echo getAmtCustom($value->given_amount); ?></td>
                                    <td class="text-center"><?php echo getAmtCustom($value->change_amount); ?></td>
                                </tr>
                                <?php
                            }
                        endif;
                        ...
                        <tr>
                            ...
                            <th class="text-center"><?php echo getAmtCustom($given_amount); ?></th>
                            <th class="text-center"><?php echo getAmtCustom($changeamount); ?></th>
                        </tr> 
                    </tbody>
                </table>
            </div>
...
<div id="product-filter" class="filter-modal">
    <div class="filter-modal-body">
        ...
        <?php echo form_open(base_url() . 'Report/tipReport', $arrayName = array('id' => 'tipReport')) ?>
        <div class="row">
            ...
            <div class="col-12 mb-2">
                <button type="submit" name="submit" value="submit" class="new-btn tipReport">
