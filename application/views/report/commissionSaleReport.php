...
<div class="main-content-wrapper">
    ...
    <section class="content-header">
        <div class="row justify-content-between">
            <div class="col-6 p-0">
                <h3 class="top-left-header mt-2"><?php echo lang('commission').' '.lang('report'); ?></h3>
            </div>
            <?php $this->view('updater/breadcrumb', ['firstSection'=> lang('report'), 'secondSection'=> lang('commission').' '.lang('report')])?>
        </div>
    </section>
    ...
    <div class="box-wrapper">
        ...
        <div class="report_header">
            ...
            <h5 class="outlet_info">
                <strong><?php echo lang('commission_report'); ?></strong>
            </h5>
        ...
        <div class="table-box">
            <div class="box-body">
                ...
                <input type="hidden" class="datatable_name"  data-filter="yes" data-title="<?php echo lang('commission').' '.lang('report'); ?>" data-id_name="datatable">
                                ...
                                foreach ($employeeSaleReport as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <?php }else if($product_invoice == 'Product_Wise'){?>
                                            <td>
                                                <?php 
                                                echo escape_output($value->item_name) ?>
                                            </td>
                                        <?php } else{?>
                                            <td>
                                            <?php 
