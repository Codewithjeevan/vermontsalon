                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-6">
                        <div class="vat-breakdown-box mt-3 mb-0" style="background:#e7f6fb;color:#0c5889;border:1px solid #0c5889;border-left:4px solid #0dcaf0;border-radius:4px;padding:8px 12px;">
                            <div class="d-flex justify-content-between flex-wrap" style="gap:8px;">
                                ...
                                <span><strong>VAT %:</strong> <span id="vat_rate_label">0</span>%</span>
                                <span><strong>Taxable:</strong> <span id="taxable_amount_label">0</span></span>
                                <span><strong>VAT:</strong> <span id="vat_amount_label">0</span></span>
                                <span><strong>Total (Inc.):</strong> <span id="grand_total_label">0</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                <input type="hidden" name="vat_percentage" id="vat_percentage_hidden" value="0">
                <input type="hidden" name="taxable_amount" id="taxable_amount_hidden" value="0">
