                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <input  name="price" class="form-control" placeholder="<?php echo lang('price'); ?>" value="<?php echo escape_output(@$customer_information->price); ?>">
                        </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <input  name="nationality" class="form-control" placeholder="<?php echo lang('nationality'); ?>" value="<?php echo escape_output(@$customer_information->nationality); ?>">
                        </div>
