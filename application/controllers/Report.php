...
class Report extends Cl_Controller {
    ...
    public function __construct() {
        ...
        }elseif($segment_1=="Report" && $segment_2 == "dailySummaryReport" || $segment_1=="Report" && $segment_2 == "summarySalesReport" || $segment_2 == "therapistReport" || $segment_1=="Report" && $segment_2 == "printDailySummaryReport" || $segment_2 == "allstylishReport"){
     ...
     * @return void
     */
    public function allstylishReport() {
        $data = array();
        $outlet_id  = isset($_POST['outlet_id']) && $_POST['outlet_id']?$_POST['outlet_id']:'';
        $data['outlet_id'] = $outlet_id;
        $company_id = $this->session->userdata('company_id');
