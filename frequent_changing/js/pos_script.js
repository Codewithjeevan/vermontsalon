$(function () {
    ...
    $(document).on('click', '#add_to_cart', function () {
        ...
        if($.trim($('#select2-seller_id-container').text()) == 'Select Employee'){
            Swal.fire({
                title: warning + "!",
